...
class NukeSessionCollector(HookBaseClass):
    ...
    def collect_nuke_backup(self, settings, parent_item):
        ...
        if work_template_setting:
            work_template = publisher.engine.get_template_by_name('nuke_asset_publish')
    ...
    def collect_daily_exr(self, settings, parent_item):
        ...
        render_template = current_engine.get_template_by_name('nuke_render_publish_asset')
    ...
    def collect_elements(self, settings, parent_item):
        ...
        for node_type in _NUKE_OUTPUTS:
            ...
            for node in all_nodes_of_type:
                ...
                # construct publish name:
                current_engine = sgtk.platform.current_engine()
                render_template = current_engine.get_template_by_name('nuke_element_publish_asset')
                movie_template = current_engine.get_template_by_name('nuke_asset_elements_movie')
